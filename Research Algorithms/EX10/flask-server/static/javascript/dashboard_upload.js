(() => {
  ...
  const AlgoFile = document.getElementById('AlgoFile')
  ...
  const ExampleAlgoFile = document.getElementById('ExampleAlgoFile')
  ...
  ExampleAlgoFile.addEventListener("click", function (){
    Greeting.hidden = true
    Algo1.hidden = true
    Algo2.hidden = true
    Part.hidden = true
    Expl.hidden = true
    AlgoFile.hidden = false
  })
